...
//
//        when(repository.getOwnedDomains(currentManager.getUuid(), DEFAULT_LIMIT, DEFAULT_OFFSET)).thenReturn(mockedDomains);
//        ListResource<Domain> ownedDomains = control.getOwnedDomains(DEFAULT_LIMIT, DEFAULT_OFFSET);
//        verify(repository, times(1)).getOwnedDomains(currentManager.getUuid(), DEFAULT_LIMIT, DEFAULT_OFFSET);
...
//
//        when(repository.find(Manager.class, currentManager.getUuid())).thenReturn(currentManager);
//
...
//        when(repository.find(Domain.class, domainUuid)).thenReturn(actualDomainStub);
//        when(currentManager).thenReturn(man1);
//
...
//        verify(currentManager).equals(currentManager);
//
//    }
//
